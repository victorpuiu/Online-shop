...
//        return entityManager.createQuery("select p from property p where p.price >= :min", Property.class)
...
//                .createQuery("select p from property p where p.price >= :min and p.price <= :max", Property.class)
//                .setParameter("min", min)
//                .setParameter("max", max)
//                .getResultList();
//    }
